  ...
  return (
    <div className="container section-padding">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        {/* Official Media Card */}
        <Link 
          href={`/${locale}/media/official`}
          className="group bg-white rounded-lg shadow-sm hover:shadow-lg transition-all p-8 text-center"
        >
          <div className="mb-6">
            <svg className="w-16 h-16 mx-auto text-forest-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
          </div>
          <h2 className="text-2xl font-display font-semibold text-brown-900 mb-3 group-hover:text-forest-600 transition-colors">
          ...
          <div className="flex justify-center gap-4 text-brown-500">
